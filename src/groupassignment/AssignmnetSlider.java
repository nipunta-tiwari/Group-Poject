...
public class AssignmnetSlider {
	...
	public static void main(String args[]) throws IOException, InterruptedException {
	 ...
	 // 3. sliding handles
		...
		WebElement leftslider1 = driver.findElement(By.xpath("//div[@class='HQL4QS _28DFQy']"));
		WebElement rightslider2 = driver.findElement(By.xpath("//div[@class='HQL4QS WC_zGJ']"));
		
		int slidersize = slider.getSize().width;
		System.out.println("Slidersize = "+slidersize);
		
		Actions myaction = new Actions(driver);
		myaction.dragAndDropBy(leftslider1, slidersize/3, 0).build().perform();
		myaction.pause(3000);
		myaction.dragAndDropBy(rightslider2, slidersize/-3, 0).build().perform();
...
//		driver.switchTo().window(handle2);
     ...
     // 12. Comparing final price with calculated amount
